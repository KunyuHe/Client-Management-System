...
class Auth:
    ...
    @classmethod
    def generate_access_token(cls, user_id, algorithm='HS256', exp=1):
        """
        生成access_token
        :param user_id:自定义部分
    ...
    @classmethod
    def generate_refresh_token(cls, user_id, algorithm='HS256', fresh=30):
        """
        生成refresh_token
        :param user_id:自定义部分
        :param algorithm:加密算法
    ...
    @classmethod
    def encode_auth_token(cls, user_id, exp=2, fresh=30, algorithm='HS256'):
        """
        :param user_id: 用户ID
